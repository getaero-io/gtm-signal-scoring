...
function normalizeLemlist(payload: Record<string, unknown>): NormalizedPayload {
  return {
    ...
    reply_text: (payload.replyText || payload.text) as string | undefined,
    email: payload.email as string | undefined,
    first_name: (payload.firstName || payload.leadFirstName) as string | undefined,
    last_name: (payload.lastName || payload.leadLastName) as string | undefined,
    company: payload.companyName as string | undefined,
    campaign_id: payload.campaignId as string | undefined,
    campaign_name: (payload.campaignName || payload.name) as string | undefined,
    linkedin_url: (payload.linkedinUrl || payload.linkedinUrlSalesNav) as string | undefined,
